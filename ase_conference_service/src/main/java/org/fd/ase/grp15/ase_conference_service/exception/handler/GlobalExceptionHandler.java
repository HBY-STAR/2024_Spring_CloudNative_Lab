...
public class GlobalExceptionHandler {
    ...
    public static Map<ConferenceServiceErrorCode, HttpStatus> codeToStatusMap = Map.ofEntries(
            ...
            Map.entry(ConferenceServiceErrorCode.ERR_NOT_FUTURE_DATE, HttpStatus.BAD_REQUEST),
            ...
            Map.entry(ConferenceServiceErrorCode.ERR_RESULT_TIME_AFTER_START_TIME, HttpStatus.BAD_REQUEST),
