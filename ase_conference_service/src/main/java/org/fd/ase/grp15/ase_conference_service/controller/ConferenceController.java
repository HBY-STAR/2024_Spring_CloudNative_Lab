...
public class ConferenceController {
    ...
    @PostMapping("/getAllTopics/{conferenceName}")
    public WithDataSuccessfulResponse<List<String>> getAllTopics(@PathVariable @Validated String conferenceName) {
        List<String> data = conferenceService.getAllTopics(conferenceName);
        return new WithDataSuccessfulResponse<>("获取会议所有主题成功", data);
    }
