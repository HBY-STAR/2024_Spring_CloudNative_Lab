...
class PCMInvitationServiceImplTest {
    ...
    void invitePCM() {
        ...
        InvitePCMParams params1 = new InvitePCMParams(sender, conferenceName, new ArrayList<String>(List.of("cx2")),new ArrayList<>());
    ...
    void searchSentInvitations() {
        ...
        InvitePCMParams params1 = new InvitePCMParams("cx1", "conferenceTest1", new ArrayList<String>(List.of("cx2", "cx3")),new ArrayList<>());
        inviteService.invitePCM(params1);
    ...
    void searchReceivedInvitation() {
        ...
        InvitePCMParams params1 = new InvitePCMParams("cx1", "conferenceTest1", new ArrayList<String>(List.of("cx3")),new ArrayList<>());
    ...
    void handleInvitation() {
        InvitePCMParams params1 = new InvitePCMParams("cx1", "conferenceTest1", new ArrayList<String>(List.of("cx2")),new ArrayList<>());
        InvitePCMParams params2 = new InvitePCMParams("cx3", "conferenceTest2", new ArrayList<String>(List.of("cx4")),new ArrayList<>());
        ...
        HandleInvitationParams handleInvitationParams1 = new HandleInvitationParams("cx2", notification1.getNotificationId(), true,new ArrayList<>());
        HandleInvitationParams handleInvitationParams2 = new HandleInvitationParams("cx4", notification2.getNotificationId(), false,new ArrayList<>());
    ...
    void searchConferenceInvitations() {
        ...
        InvitePCMParams params1 = new InvitePCMParams("cx1", "conferenceTest1", new ArrayList<String>(List.of("cx2", "cx3", "cx4")),new ArrayList<>());
        inviteService.invitePCM(params1);
