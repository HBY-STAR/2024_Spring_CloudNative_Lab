...
public class ServiceCallConfig {
    ...
    @Bean
    public IConferenceService conferenceService(HttpServiceProxyFactory httpServiceProxyFactory) {
        return httpServiceProxyFactory.createClient(IConferenceService.class);
    }

    @Bean
    public IContributeService contributeService(HttpServiceProxyFactory httpServiceProxyFactory) {
        return httpServiceProxyFactory.createClient(IContributeService.class);
    }
}
