...
public class UserController {
    ...
    public WithDataSuccessfulResponse<List<UserConferenceRoleDTO>> userConferenceRoleSelf(@PathVariable String conferenceName) {
        ...
        List<UserConferenceRoleDTO> roles = userConferenceRoleService.loadUserRolesInConference2(username, conferenceName);

        return new WithDataSuccessfulResponse<>("获取用户会议角色成功", roles);
    }
